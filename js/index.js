$(document).ready(function() {
  ...
  $("#majuscules").click(function() {
    if ($("body").css("text-transform") == "none" || $("body").css("text-transform") == "") 
...
function crearHospital() {
   ...
   ** */
    ...
    var htmlINICIInputNomPacient = '<input type=\"text\" name=\"Nom Pacient\" onblur=\"validaQueNoEsBuit(this)\" placeHolder=\"Nom pacient\" data-toggle=\"tooltip\" title=\"Introdueix el nom del pacient\" id=\"nomPacient';

    var htmlINICIInputSelect = '<select data-toggle="tooltip" title="Introdueix la malaltia del pacient" id="malaltia';
...
function gestioDonarDalta(llitPacient) {
  ...
  '<div class="text-center">' +
    '<button type="button" class="btn btn-primary mt-4" onClick="window.location.reload()" data-toggle="tooltip" title="Fes clic aquí si vols començar un altre cop amb un nou Hospital">TORNAR A COMENÇAR</button>' +
  '</div>');
}
